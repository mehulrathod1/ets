...
class ShareLocationScreen extends StatefulWidget {
  ShareLocationScreen({required this.appBar, Key? key}) : super(key: key);
  bool appBar;
...
class _ShareLocationScreenState extends State<ShareLocationScreen> {
  ...
  EmployeeShareLocationController employeeShareLocationController =
      EmployeeShareLocationController();
                  ...
                  child: InkWell(
                    onTap: () async {
                      if (stopLocation == true && currentAddress!.isNotEmpty) {
                        await employeeShareLocationController
                            .stopShareLocation(context, currentAddress!)
                            .then((value) => {
                                  setState(() {
                                    if (value == true) {
                                      startLocation = true;
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          color: stopLocation
                              ? appThemelightPink
                              : appThemelightPink.withOpacity(0.5)),
                      child: const Center(
                        child: Padding(
                  ...
                  child: InkWell(
                    onTap: () async {
                      if (startLocation == true && currentAddress!.isNotEmpty) {
                        await employeeShareLocationController
                            .startShareLocation(context, currentAddress!)
                            .then((value) => {
                                  setState(() {
                                    if (value == true) {
                                      startLocation = false;
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          color: startLocation
                              ? appThemeGreen
                              : appThemeGreen.withOpacity(0.50)),
                      child: const Center(
                        child: Padding(
                          padding: EdgeInsets.all(8),
