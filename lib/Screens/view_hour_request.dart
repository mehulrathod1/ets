...
class _ViewHourRequestState extends State<ViewHourRequest> {
  ...
  Future initialize(BuildContext context) async {
    setState(() {
      loading = true;
      employeeGetHourRequestController.getEmployeeRequest(context, page: page).then((value) {
        setState(() {
          employeeGetHourRequestModel = value;
          requestList = employeeGetHourRequestModel!.data.list;
          loading = false;
          page = page + 1;
          totalPage = employeeGetHourRequestModel!.data.paginationInfo.totalPages;
        });
      });
  ...
  Future scrollListener() async {
    ...
    if (controller!.position.extentAfter <= 0) {
      ...
      await employeeGetHourRequestController.getEmployeeRequest(context, page: page).then((value) {
        if (value != null) {
          setState(() {
            employeeGetHourRequestModel = value;
