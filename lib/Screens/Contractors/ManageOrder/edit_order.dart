...
class EditOrder extends StatefulWidget {
  EditOrder({required this.id, required this.estimateId, required this.orderStatus, required this.orderName, required this.changeDescription, required this.orderDescription, required this.amount, required this.startDate, required this.dueDate, required this.signature, Key? key}) : super(key: key);
  String id;
  String estimateId;
  String orderStatus;
  String orderName;
...
class _EditOrderState extends State<EditOrder> {
  EmployeeEditOrderController editOrderController = EmployeeEditOrderController();
  ...
  void initState() {
    ...
    Future.delayed(const Duration(microseconds: 0), () async {
      await editOrderController.getEstimateOrderListForEmployee(context).then((value) => {
            if (value != null)
              {
                setState(() {
                  ...
                  for (int i = 0; i < value.length; i++) {
                    if (value[i]["estimate_id"] == widget.estimateId) {
                      editOrderController.estimateId.text = value[i]["estimate_id"];
                        ...
                        child: TextField(
                          ...
                          onTap: () async {
                            ...
                            if (pickedDate != null) {
                              ...
                              setState(() {
                                editOrderController.startDate.text = formattedDate;
                              });
                            } else {
                        ...
                        child: GestureDetector(
                          onTap: () async {
                            if (selectedOrder == "Test Estimate Section") {
                              ...
                              await editOrderController.editOrder(context, id: widget.id, signature: signaturePath);
                            }
                          },
                          child: Container(
