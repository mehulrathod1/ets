...
class _AddInvoiceForContactState extends State<AddInvoiceForContact> {
  ...
  onChangeDropdownBoxSize(selectedTest) {
    setState(() {
      ...
      addInvoiceForContact.contactId.text = selectedTest['id'];
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Center(
          child: Text("Add Invoice For Contact",
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                          height: 40,
                          child: TextField(
                            controller: addInvoiceForContact.description,
                        ...
                        SizedBox(
                          height: 40,
                          child: TextField(
                            controller: addInvoiceForContact.amount,
                        ...
                        SizedBox(
                          height: 40,
                          child: TextField(
                            controller: addInvoiceForContact.invoiceDate,
                            style: const TextStyle(
                                height: 1.7, fontSize: 18, color: Colors.black),
                            maxLines: 1,
                            decoration: InputDecoration(
                            ...
                            onTap: () async {
                              ...
                              if (pickedDate != null) {
                                ...
                                setState(() {
                                  addInvoiceForContact.invoiceDate.text =
                        ...
                        SizedBox(
                          height: 40,
                          child: TextField(
                            controller: addInvoiceForContact.signName,
                            style: const TextStyle(
                                height: 1.7, fontSize: 18, color: Colors.black),
                            maxLines: 1,
                            decoration: InputDecoration(
