...
import '../../../Controller/EmployeeController/employee_delete_note_controller.dart';
import '../../../Controller/EmployeeController/employee_note_controller.dart';
import '../../../Models/EmployeeModel/employee_delete_note_model.dart';
import '../../../Models/EmployeeModel/employee_notes_model.dart';
...
class _ManageNoteState extends State<ManageNote> {
  ...
  late EmployeeDeleteNoteModel deleteNoteModel;
  ...
  Future initialize(BuildContext context) async {
    employeeNoteController.getEmployeeContact(context).then((value) {
      setState(() {
        noteModel = value;
                                            ...
                                            onTap: () {
                                              deleteNoteController
                                                  .deleteNote(
                                                      context, detail.id)
                                                  .then((value) {
                                                deleteNoteModel = value;
                                                print(deleteNoteModel.message);
                                              });
                                              initialize(context);
                                            },
                                            child: Container(
