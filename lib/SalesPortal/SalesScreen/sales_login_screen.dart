...
class _SalesLoginScreenState extends State<SalesLoginScreen> {
  ...
  SalesLoginController salesLoginController = SalesLoginController();
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: TextField(
                    controller: salesLoginController.userName,
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    controller: salesLoginController.password,
                    maxLines: 1,
                    style: const TextStyle(height: 1.7, color: Colors.black),
                    decoration: InputDecoration(
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      if (salesLoginController.userName.text.isEmpty) {
                      ...
                      } else if (salesLoginController.password.text.isEmpty) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                        ...
                        salesLoginController.salesLogin(context);
                      }
                    },
                    child: Container(
