...
class ResellerAgreement extends StatefulWidget {
  const ResellerAgreement({Key? key}) : super(key: key);

  @override
  State<ResellerAgreement> createState() => _ResellerAgreementState();
}

class _ResellerAgreementState extends State<ResellerAgreement> {
  @override
                            ...
                            Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Expanded(
                                    child: Text(
                                      "This RESELLER AGREEMENT (the Agreement) is entered into this day of (the Effective Date) by and between Employee Tracking Solutions, Inc., a DE Corporation (the Company), with offices at 5550 Glades Road, Boca Raton FL 33431 and [NAME OF RESELLER], a[company] with offices at [PRINCIPAL ADDRESS] (Reseller). RECITALS \n  WHEREAS the Company owns and licenses an employee tracking and CRM service (the Service); WHEREAS Reseller desires to market, sell and support the Service; and WHEREAS the Company desires to appoint Reseller as an authorized reseller of the Service pursuant to the terms and conditions of this Agreement. NOW THEREFORE, in consideration of the mutual promises contained herein and for other good and valuable consideration, the receipt and sufficiency of which are hereby acknowledged, the parties agree as follows:",
