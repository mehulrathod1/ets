...
import '../../CompanyPortal/CompanyScreens/company_home.dart';
import '../../Screens/UserSelectionScreen.dart';
import '../../utils/Colors.dart';
import '../ManageAgent/manage_agent.dart';
import '../ManageSalesCompany/ManageSalesCompany.dart';
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            menuItem(2, "Add Agent", Icons.person_outline,
                currentPage == DrawerSelection.AddAgent ? true : false),
            menuItem(3, "Company", Icons.person_outline,
                currentPage == DrawerSelection.Company ? true : false),
            menuItem(4, "Request", Icons.weekend_outlined,
            ...
            Padding(
              padding: const EdgeInsets.only(top: 250.0, right: 16, bottom: 16),
              child: Align(
