...
class _CompanyEditCompanyInvoiceState extends State<CompanyEditCompanyInvoice> {
  ...
  @override
  void initState() {
    manageCompanyContactInvoice.id.text = widget.id;
    manageCompanyContactInvoice.contactId.text = widget.contactId;
    manageCompanyContactInvoice.description.text = widget.description;
    manageCompanyContactInvoice.amount.text = widget.amount;
    manageCompanyContactInvoice.invoiceDate.text = widget.invoiceDate;
    manageCompanyContactInvoice.signName.text = widget.signatureName;
                ...
                setState(() {
                  ...
                  for (int i = 0; i < value.length; i++) {
                    if (value[i]["id"] == widget.contactId) {
                      manageCompanyContactInvoice.contactId.text =
                          value[i]["id"];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Center(
          child: Text("Edit Contact Invoice",
