...
import '../../../Controller/CompanyController/get_company_order_controller.dart';
...
class _ManageCompanyOrderState extends State<ManageCompanyOrder> {
  ...
  Future initialize(BuildContext context) async {
    companyOrderController.getAllCompanyOrder(context).then((value) {
      setState(() {
        getCompanyOrderModel = value;
        orderList = getCompanyOrderModel.data.list;
        print(getCompanyOrderModel.message);
      });
    });
  }
