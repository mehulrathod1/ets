...
import '../../Controller/CompanyController/compnay_login_controller.dart';
...
import '../CompanyContractors/company_contractors_screen.dart';
  ...
  Future initialize(BuildContext context) async {
    companyLoginController.getCompanyProfile(context).then((value) {
      setState(() {
        ...
        print(companyProfileModel.data.city);
      });
    });
  }
