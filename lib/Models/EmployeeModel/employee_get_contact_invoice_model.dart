...
class EmployeeGetInvoiceContactModel {
  String status;
  String message;
  Data data;

  EmployeeGetInvoiceContactModel({
    required this.status,
    required this.message,
    required this.data,
  });

  factory EmployeeGetInvoiceContactModel.fromRawJson(String str) =>
      EmployeeGetInvoiceContactModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory EmployeeGetInvoiceContactModel.fromJson(Map<String, dynamic> json) =>
      EmployeeGetInvoiceContactModel(
        status: json["status"],
