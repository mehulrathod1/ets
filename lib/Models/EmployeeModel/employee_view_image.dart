...
//
//     final employeeViewImageModel = employeeViewImageModelFromJson(jsonString);

import 'dart:convert';

class EmployeeViewImageModel {
  EmployeeViewImageModel({
  ...
  factory EmployeeViewImageModel.fromRawJson(String str) =>
      EmployeeViewImageModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory EmployeeViewImageModel.fromJson(Map<String, dynamic> json) =>
      EmployeeViewImageModel(
        status: json["status"],
